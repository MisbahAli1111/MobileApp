...
//    @Query("SELECT v.registrationNumber FROM Vehicle v INNER JOIN v.maintenance_record r WHERE r.id = :recordId")
//    Optional<String> getRegistrationNumberFromRecordId(@Param("recordId") Long recordId);
